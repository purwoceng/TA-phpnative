      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <?php
              include('../../koneksi.php');
              $query = mysql_query("Select * FROM petugas where idpet='$_GET[id]'");
                  ...
                  <div class="x_content">
                    ...
                    <form action="actionptgs.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="namapet" placeholder="" value="<?php echo $data['namapet'];?>" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label for="select" class="col-lg-2 control-label">Jenis Kelamin</label>
                        <div class="col-lg-15">
                          <select name="jk" class="form-control">
                            <option value="<?php echo $data['jk'];?>">-pilih-</option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" name="password" placeholder="" value="<?php echo $data['password'];?>" class="form-control">
                      </div>
                      ...
                      <div class="card-footer">                      
                        ...
                        fa-times-circle"><a href="index.php"></i>Batal</button>
                      </div>
                    </form>
