              ...
              <div class="x_title">
               ...
               <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <?php
                        include("../../koneksi.php");
                         $result = mysql_query("SELECT * FROM proyek inner join pelanggan on pelanggan.idpel=proyek.idpel  ORDER BY idpro ASC");
                      ?>
                      <thead>
                        <tr>
                          <th>No</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $user_data['idpel']?>--<?php echo $user_data['namapel']?></td>
