...
<div class="navbar nav_title" style="border: 0;">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <a href="../direktur/index.php"><img src="../../images/logo1.jpg" alt="..." class="img-circle profile_img"></a>

              </div>
              <div class="profile_info">
                <span>Selamat Datang</span>
                <a href="index.php"><h2><?php echo $_SESSION['namapet']; ?>(Direktur)</h2></a>
              </div>
            </div>
            <!-- menu profile quick info -->
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Daftar <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="rekapproyek.php">Rekapitulasi Proyek</a></li>
                      <li><a href="rekappengadaan.php">Rekapitulasi Pengadaan</a></li>
