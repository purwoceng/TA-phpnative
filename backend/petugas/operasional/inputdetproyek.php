                  ...
                  <div class="x_content">
                    ...
                    <form action="actionptgs.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <?php 
                          include('../../koneksi.php');
                          mysql_query("SELECT * FROM proyek ORDER by idpro DESC");
                          ?>
              ...
              <div class="x_title">
               ...
               <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <?php
                        include("../../koneksi.php");
                         $result = mysql_query("SELECT * FROM detpinjam where idpinjam='$newID' inner join barang on barang.idbrg = detpinjam.iddetpinjam");
                      ?>
                      <thead>
                        <tr>
                          <th>No</th>
