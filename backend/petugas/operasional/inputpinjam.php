                  ...
                  <div class="x_content">
                    ...
                    <form action="actionptgs.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" name="tglpinjam" placeholder="" value="<?php echo $data['tglpinjam'];?>"  class="form-control" required autofocus>
                      </div>
                      <div class="form-group">
                        <label class="control-label">Tanggal Kembali</label>
                        <input type="date" name="tglkembali" placeholder="" value="<?php echo $data['tglkembali'];?>" class="form-control" required autofocus>
                      </div>
                       <div class="form-group">
