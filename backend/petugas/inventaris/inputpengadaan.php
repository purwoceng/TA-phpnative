          ...
          <div class="">
           <div class="page-title">
                  <div class="title_left">
                    <h3>Input Detail Pengadaan Barang</h3>
                  </div>
                </div>
                 <?php
              include('../../koneksi.php');
              $query = mysql_query("Select max(idpengbrg) as maxID FROM pengadaan");
              $data = mysql_fetch_array($query);
              $idMax = $data['maxID'];
              $noUrut = (int) substr($idMax,-3);
              $noUrut++;
              $newID = "PDB".sprintf("%03s",$noUrut);
              $tglsekarang = date("Y-m-d");
              ?>
                <?php
                  include('../../koneksi.php');
                  $query = mysql_query("Select max(iddetpengbrg) as maxID FROM detpengadaan");
                  $data = mysql_fetch_array($query);
                  $idMax = $data['maxID'];
                  $noUrut = (int) substr($idMax,-3);
                  $noUrut++;
                  $newID2 = "DPB".sprintf("%03s",$noUrut);
                  $tglsekarang = date("Y-m-d");
                  ?>
               <div class="row">
                  ...
                  <div class="x_content">
                    ...
                    <form action="actionptgs.php" method="post">
                      <div class="form-group">
                        <label class="control-label">ID Detail Pengadan</label>
                        <input type="text" name="iddetpengbrg" placeholder="" readonly value="<?php echo $newID2;?>" class="form-control" > 
                      </div>
                       <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <label class="control-label">ID Pengadaan</label>
                        <input type="text" name="idpengbrg" placeholder="" value="<?php echo $newID;?>" class="form-control" readonly>
                      </div>
                      <div class="card-footer">                      
                        <button type="submit" class="btn btn-primary btn-sm" name="inputdetpengadaan">
                  ...
                  <div class="x_content">
                    ...
                    <form action="actionptgs.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" name="tgl" placeholder="" value=""  class="form-control" required autofocus>
                      </div>
                       ...
                       <div class="form-group">
                        <label class="control-label">Dana Pengadaan</label>
                        <input type="number" name="dana" placeholder="" value=""  class="form-control" required autofocus>
                      </div>
                      <div class="card-footer">                      
                        <button type="submit" class="btn btn-primary btn-sm" name="inputpengadaan">
...
<!--                 <div class="page-title">
       ...
       <!--    Tabel Detail Peminjaman -->
            ...
            <div class="x_panel">
              <div class="x_title">
                <div class="title_left">
                  <h3>Daftar Input Detail Pengadaan</h3>
                </div>
               <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <?php
                        include("../../koneksi.php");
                         $result = mysql_query("SELECT * FROM detpengadaan inner join barang on barang.idbrg=detpengadaan.idbrg where idpengbrg='$newID'");
                      ?>
                      <thead>
                        <tr>
                          <th>No</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $user_data['iddetpengbrg']?></td>
