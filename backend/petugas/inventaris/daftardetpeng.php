            ...
            <div class="x_panel">
              <div class="x_title">
                <div class="title_left">
                  <h3>Daftar Detail Pengadaan Barang</h3>
                </div>
               <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <?php
                        include("../../koneksi.php");
                        $id=$_GET['id'];
                         $result = mysql_query("SELECT * FROM detpengadaan inner join barang on barang.idbrg=detpengadaan.idbrg  where idpengbrg='$id'");
                      ?>
                      <thead>
                        <tr>
                          <th>No</th>
